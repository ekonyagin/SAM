...
class TrainOptions:
    ...
    def initialize(self):
        ...
        self.parser.add_argument(
            "--lpips_lambda", default=0, type=float, help="LPIPS loss multiplier factor"
        )
        self.parser.add_argument(
        ...
        self.parser.add_argument(
            "--aging_lambda", default=0, type=float, help="Aging loss multiplier factor"
        )
        self.parser.add_argument(
            "--cycle_lambda", default=0, type=float, help="Cycle loss multiplier factor"
        )
        ...
        self.parser.add_argument(
            "--pretrained_psp_path",
            default="/home/e.konyagin/pixel2style2pixel/path/checkpoints/best_model.pt",
            type=str,
